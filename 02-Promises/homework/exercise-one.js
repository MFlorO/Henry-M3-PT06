...
function problemB() {
  ...
  promisifiedReadFile("poem-one/stanza-02.txt").then((data)=>{blue(data)}) //data es igual a stanza2
  promisifiedReadFile("poem-one/stanza-03.txt").then((data)=>{blue(data)}) 
}
...
function problemC() {
  ...
  .then((data) => { //data es igual a stanza2
    blue(data)
    return promisifiedReadFile("poem-one/stanza-03.txt") //SE RETORNA EL VALOR DE ESTA PROMESA
   })
   //Y SE CAPTURA EL VALOR RETORNADO EN EL SIGUIENTE .then
  .then((data)=>{ //data es igual a stanza3
    blue(data)
    console.log("done")
  })
...
function problemD() {
  ...
  .then(
    (data) => { //data es igual a stanza4
    blue(data)
  
  }).catch(
    (razon) => {
    magenta(new Error(razon))
  })
...
function problemF() {
  ...
  //SE ESCRIBE EL console.log("done") EN AMBOS LADOS PORQUE SON DOS OPCIONES DONDE PUEDE ENTRAR
